...
class PersonalityTest {
  ...
  renderPreviewGrid() {
    ...
    grid.innerHTML = '';
    grid.style.cssText = 'display:grid !important;grid-template-columns:repeat(6,150px) !important;gap:10px !important;justify-content:center !important;margin-top:16px;';
